...
const PRODUCTS = [
  {
    ...
    color: "black",
    description:
      "선택한 상품과 비슷한 무드로 추천했어요. 클래식한 실루엣과 편안한 착용감이 돋보이는 로퍼예요.",
  },
  {
    id: 2,
    image: roundBagImg,
    ...
    color: "black",
    description:
      "선택한 상품과 비슷한 컬러로 추천했어요. 동그란 실루엣과 스터드 장식이 포인트인 라운드백입니다.",
  },
  {
    id: 3,
    image: bucketBagImg,
    ...
    color: "cognac",
    description:
      "선택한 상품과 비슷한 꼬냑 컬러로 추천했어요. 가벼운 착용감과 넉넉한 수납공간이 돋보이는 버킷백입니다.",
  },
  {
    id: 4,
    image: twillyImg,
    ...
    color: "multi",
    description:
      "선택한 상품과 잘 어울리는 패턴으로 추천했어요. 가방에 포인트를 더해주는 트윌리 스카프입니다.",
  },
];

function ChoosePage({ isLoggedIn = false }) {
  ...
  return (
    <div className="choose-page-wrap">
      <div className="choose-header">
        <TimePortalTitle></TimePortalTitle>
      </div>
      ...
      <div
        className={toastVisible ? "choose-toast is-visible" : "choose-toast"}
      >
        상품이 장바구니에 담겼습니다.
      </div>
